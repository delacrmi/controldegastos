...
var formPanel = React.createClass({displayName: 'formPanel',
  ...
  render: function() {
    ...
    return (React.DOM.div({className: "row green animated flipInX"}, 
          React.DOM.div({className: "col-lg-7 col-md-9 col-sm-10 col-xs-12 inline-block"}, 
            React.DOM.div({className: "panel"}, 
              React.DOM.div({className: "panel-header animated bounceIn delay-1"}, 
                React.DOM.h2({className: "pacifico big blue"}, "Create Account")
              ), 
...
React.renderComponent(formPanel(null), document.getElementById('content'));
},{"./input":2,"react":147}],2:[function(require,module,exports){
/** @jsx React.DOM*/

var React = require('react');

var inputAndLabel = React.createClass({displayName: 'inputAndLabel',
  ...
  render: function() {
    ...
    return React.DOM.div({className: "row"}, 
            React.DOM.label({htmlFor: this.props.name, className: this.props.classLabel}, this.props.labelText), 
            React.DOM.div({className: this.props.classDiv}, 
              React.DOM.input({id: this.props.name, name: this.props.name, type: this.props.type, placeholder: this.props.ph, className: this.props.classInput, maxLength: this.props.length})
            )
          );
  }
});
...
var input = React.createClass({displayName: 'input',
  ...
  render: function() {
    ...
    return (React.DOM.input({id: config.name, name: config.name, type: config.input.type, maxlength: config.input.length, placeholder: config.input.ph, className: config.input.class}));
  }
});
